...
export default function ShareButtons({
  ...
  const buttonClass =
    "w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-200 hover:scale-110 active:scale-95 hover:shadow-md group relative";
    ...
    <div className={`flex items-center gap-1 ${className}`}>
      ...
      <button
        ...
        style={{
          ...
          border: `1px solid ${copied ? "var(--brand)" : "var(--border)"}`,
