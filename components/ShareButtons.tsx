...
export default function ShareButtons({
  ...
  const buttonClass =
    "flex items-center gap-1 px-2 py-1 rounded text-xs font-medium transition-all duration-200 hover:scale-105 active:scale-95";
  ...
  return (
    <div className={`flex flex-wrap items-center gap-1 ${className}`}>
      ...
      >
        ...
        <span className="hidden sm:inline" style={{ fontSize: "0.6875rem" }}>Twitter</span>
      </button>
      ...
      >
        ...
        <span className="hidden sm:inline" style={{ fontSize: "0.6875rem" }}>Facebook</span>
      </button>
      ...
      >
        ...
        <span className="hidden sm:inline" style={{ fontSize: "0.6875rem" }}>WhatsApp</span>
      </button>
      ...
      >
        ...
        <span className="hidden sm:inline" style={{ fontSize: "0.6875rem" }}>Telegram</span>
      </button>
      ...
      >
        ...
        <span className="hidden sm:inline" style={{ fontSize: "0.6875rem" }}>Reddit</span>
      </button>
      ...
      >
        {copied ? (
          <>
            ...
            <span className="hidden sm:inline" style={{ fontSize: "0.6875rem" }}>¡Copiado!</span>
          </>
        ) : (
          <>
            <svg
            ...
            <span className="hidden sm:inline" style={{ fontSize: "0.6875rem" }}>Copiar</span>
          </>
        )}
      </button>
