...
export default function ThreadCard({
  ...
  return (
    ...
    >
      {/* Left Column: Vote Buttons */}
      <div className="flex-shrink-0 bg-black/5 dark:bg-white/5 w-10 sm:w-12 flex flex-col items-center pt-2 border-r border-[var(--border-light)] z-20 relative">
        <VoteButtons
          threadId={thread.id}
      ...
      <div className="flex-1 p-2 sm:p-3 relative hover:bg-[var(--card-hover)] transition-colors">
        {/* Header: Metadata */}
        <div
        ...
        <div className="flex items-center gap-2 mt-auto relative z-10">
          <div className="flex items-center gap-1 px-2 py-1 rounded hover:bg-[var(--border-light)] transition-colors text-xs font-bold text-[var(--muted)]">
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
